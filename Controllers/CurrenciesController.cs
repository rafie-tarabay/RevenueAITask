...
namespace RevenueAITask.Controllers
{
    ...
    public class CurrenciesController : Controller
    {
        ...
        public CurrenciesController(RevenueAIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CurrencyId,Currency1")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CurrencyId,Currency1")] Currency currency)
        {
