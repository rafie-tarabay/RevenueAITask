...
namespace RevenueAITask.Controllers
{
    ...
    public class UserTypesController : Controller
    {
        ...
        public UserTypesController(RevenueAIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserTypeId,UserTypeDesc")] UserType userType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserTypeId,UserTypeDesc")] UserType userType)
        {
